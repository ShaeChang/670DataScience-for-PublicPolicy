...
<head>
  ...
  <link rel="stylesheet" media="all" href="/assets/application-7fdc94847f700e90d7ec906195b158f501ea1e9316828a8dcba821879ce6322e.css" />
...
<meta name="csrf-token" content="77g2VzrapD9f3D3xYYfFApXYtCROfaGRitVE2d09gDxgMt+DlGtTUzWacUbu+0N+ckAjXfhbTIlvEp6xAniHOg==" />
...
<div class="login-page">
  ...
  <div class="row">
    <section class="login-col login-form col-md-5 col-sm-6">
      <form class="new_login" id="new_login" action="/authentication/login" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="6WoRUZaGmOEi7xeOZy4XL1VF1zsDOv83GkREwgORZKJm4PiFODdvjUipWznoUpFTst1AQrUcEi//g56q3NRjpA==" />
...
<input placeholder="Enter password" class="form-control" type="password" name="login[password]" id="login_password" /></div>
    ...
    <section class="login-col login-help col-md-7 col-sm-6">
      ...
      <p><a href="https://www.ipums.org">IPUMS</a> uses a <strong>common user management system</strong> for several data projects:  IPUMS International, IPUMS USA, IPUMS CPS, IPUMS Higher Ed, NHGIS, IPUMS Health Surveys, IPUMS Time Use, and IPUMS Terra.</p>

      <p>If you already have an account with any of these projects, sign in here.  If you've not yet registered for IPUMS, you will be directed to the project registration page after signing in.</p>

      <p>If you do not have an account for any IPUMS project, you may create one <a href="/user/new">here</a>.
...
<script src="/assets/application-4c316c026049cb8eddb636c2ae67595430250255e101fe229f98ee6c93ea6209.js"></script>
